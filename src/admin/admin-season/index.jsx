...
const AdminSeason = () => {
	...
	const renderSeasonDrivers = useMemo(() => <AdminSeasonDrivers show={activeTabIndex === 0} />, [activeTabIndex]);
	const renderSeasonRaces = useMemo(() => <AdminSeasonTracks show={activeTabIndex === 1} />, [activeTabIndex]);
