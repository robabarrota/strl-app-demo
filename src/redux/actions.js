...
export const setQualifying = (qualifying) => ({
	type: SET_QUALIFYING,
	payload: { qualifying },
});
...
export const setFastestLaps = (fastestLaps) => ({
	type: SET_FASTEST_LAPS,
	payload: { fastestLaps },
});
...
export const setMedalCount = (medalCount) => ({
	type: SET_MEDAL_COUNT,
	payload: { medalCount },
});
...
export const setDriverPoints = (driverPoints) => ({
	type: SET_DRIVER_POINTS,
	payload: { driverPoints },
});
...
export const setDriverStats = (driverStats) => ({
	type: SET_DRIVER_STATS,
	payload: { driverStats },
});
...
export const setConstructorPoints = (constructorPoints) => ({
	type: SET_CONSTRUCTOR_POINTS,
	payload: { constructorPoints },
});

export const FETCH_CONSTRUCTOR_POINTS = `${prefix}/FETCH_CONSTRUCTOR_POINTS`;
export const fetchConstructorPoints = () => ({
	type: FETCH_CONSTRUCTOR_POINTS,
});

export const SET_CONSTRUCTOR_STATS = `${prefix}/SET_CONSTRUCTOR_STATS`;
export const setConstructorStats = (constructorStats) => ({
	type: SET_CONSTRUCTOR_STATS,
	payload: { constructorStats },
});
...
export const setArchiveStats = (archiveStats) => ({
	type: SET_ARCHIVE_STATS,
	payload: { archiveStats },
});

export const FETCH_ARCHIVE_STATS = `${prefix}/FETCH_ARCHIVE_STATS`;
export const fetchArchiveStats = (seasonNumber) => ({
	type: FETCH_ARCHIVE_STATS,
	payload: { seasonNumber },
});

export const SET_SELECTED_SEASON = `${prefix}/SET_SELECTED_SEASON`;
export const setSelectedSeason = (selectedSeason) => ({
	type: SET_SELECTED_SEASON,
	payload: { selectedSeason: { content: selectedSeason } },
});

export const SET_DRIVER_TRACK_STATS = `${prefix}/SET_DRIVER_TRACK_STATS`;
export const setDriverTrackStats = (driverTrackStats) => ({
	type: SET_DRIVER_TRACK_STATS,
	payload: { driverTrackStats },
});
...
export const setSelectedTrack = (selectedTrack) => ({
	...
	payload: { selectedTrack: { content: selectedTrack } },
});

export const SET_ALL_TRACKS = `${prefix}/SET_ALL_TRACKS`;
export const setAllTracks = (allTracks) => ({
	type: SET_ALL_TRACKS,
	payload: { allTracks: { content: allTracks } },
});

export const SET_HISTORICAL_DRIVER_STATS = `${prefix}/SET_HISTORICAL_DRIVER_STATS`;
export const setHistoricalDriverStats = (historicalDriverStats) => ({
	type: SET_HISTORICAL_DRIVER_STATS,
	payload: { historicalDriverStats },
});

export const FETCH_HISTORICAL_DRIVER_STATS = `${prefix}/FETCH_HISTORICAL_DRIVER_STATS`;
export const fetchHistoricalDriverStats = () => ({
	type: FETCH_HISTORICAL_DRIVER_STATS,
});
...
export const updateActiveUser = (updateBody) => ({
...
export const fetchSeasonDrivers = (seasonId) => ({
	type: FETCH_SEASON_DRIVERS,
	payload: { seasonId },
});

export const SET_SEASON_DRIVERS = `${prefix}/SET_SEASON_DRIVERS`;
export const setSeasonDrivers = (seasonDrivers) => ({
	type: SET_SEASON_DRIVERS,
	payload: { seasonDrivers },
});

export const FETCH_SEASON_TRACKS = `${prefix}/FETCH_SEASON_TRACKS`;
export const fetchSeasonTracks = (seasonId) => ({
	type: FETCH_SEASON_TRACKS,
	payload: { seasonId },
});

export const SET_SEASON_TRACKS = `${prefix}/SET_SEASON_TRACKS`;
export const setSeasonTracks = (seasonTracks) => ({
	type: SET_SEASON_TRACKS,
	payload: { seasonTracks },
});
...
export const setConstructors = (constructors) => ({
	type: SET_CONSTRUCTORS,
	payload: { constructors },
});

export const CREATE_SEASON_DRIVER = `${prefix}/CREATE_SEASON_DRIVER`;
export const createSeasonDriver = (seasonId) => ({
	type: CREATE_SEASON_DRIVER,
	payload: { seasonId },
});

export const DELETE_SEASON_DRIVER = `${prefix}/DELETE_SEASON_DRIVER`;
export const deleteSeasonDriver = (seasonId, seasonDriverId) => ({
	type: DELETE_SEASON_DRIVER,
	payload: { seasonId, seasonDriverId },
});

export const UPDATE_SEASON_DRIVER = `${prefix}/UPDATE_SEASON_DRIVER`;
export const updateSeasonDriver = (seasonId, seasonDriverId, updateBody) => ({
